...
import com.myweather.fragment.places.PlacesFragment;
import com.niks.sdk.Place;
import com.niks.sdk.R;
import com.niks.sdk.WeatherService;
import com.niks.sdk.dataplaces.DataPlaces;
import com.niks.sdk.dataplaces.PlaceAlreadyExistException;
...
public class AddPlaceDialog extends Dialog {
	...
	//	Callbacks
	public final WeatherService.CallbackGetCoordinates getCoordinatesCallback;
	public final WeatherService.CallbackGetData getDataCallback;
	...
	public AddPlaceDialog(Context context, View addPlaceFABView, String apiKey, WeatherService weatherService, PlacesFragment.Interactions placeFragmentInteractions) {
		...
		this.getDataCallback = new WeatherService.CallbackGetData() {
			...
			@Override
			public void onNoResponseError(WeatherService.CallbackGetData.RequestStatus requestStatus) {
				showSnackbar(dialogWindow, context.getString(R.string.error_server_unreachable));
			}
